...
exports.WingsBodyCheck = {
    ...
    downloadBackup: function (input) {
        var $io0 = function (input) { return "object" === typeof input.query && null !== input.query && ("string" === typeof input.query.server_uuid && "string" === typeof input.query.backup_uuid && "string" === typeof input.query.unique_id); };
        return "object" === typeof input && null !== input && $io0(input);
    },
    downloadFile: function (input) {
        var $io0 = function (input) { return "object" === typeof input.query && null !== input.query && ("string" === typeof input.query.file_path && "string" === typeof input.query.server_uuid && "string" === typeof input.query.unique_id); };
        return "object" === typeof input && null !== input && $io0(input);
    },
    uploadFile: function (input) {
        var $io0 = function (input) { return "object" === typeof input.headers && null !== input.headers && $io1(input.headers) && ("object" === typeof input.query && null !== input.query && ("string" === typeof input.query.server_uuid && "string" === typeof input.query.user_uuid && "string" === typeof input.query.unique_id)); };
        var $io1 = function (input) { return "multipart/form-data" === input["Content-Type"]; };
        return "object" === typeof input && null !== input && $io0(input);
    },
    ...
    writeServerFileContent: function (input) {
        ...
        var $io1 = function (input) { return "text/plain" === input["Content-Type"]; };
        return "object" === typeof input && null !== input && $io0(input);
    },
    ...
    startServerTransfer: function (input) {
        var $io0 = function (input) { return "object" === typeof input.body && null !== input.body && $io1(input.body); };
        var $io1 = function (input) { return "string" === typeof input.url && "string" === typeof input.token && (undefined === input.server || "object" === typeof input.server && null !== input.server && $io2(input.server)); };
        var $io2 = function (input) { return "string" === typeof input.uuid && "boolean" === typeof input.start_on_completion; };
        return "object" === typeof input && null !== input && $io0(input);
    },
